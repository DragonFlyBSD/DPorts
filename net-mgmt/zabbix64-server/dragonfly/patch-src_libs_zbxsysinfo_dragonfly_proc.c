--- src/libs/zbxsysinfo/dragonfly/proc.c.orig	2023-07-06 19:16:03 UTC
...
+}
 ...
 typedef struct
 {
@@ -241,11 +216,7 @@ int     proc_mem(AGENT_REQUEST *request,
 	unsigned int	mibs;
...
@@ -347,11 +318,7 @@ int     proc_mem(AGENT_REQUEST *request,
 	}
 	else
 	{
-#if (__FreeBSD_version) < 500000
...
@@ -414,14 +381,7 @@ int     proc_mem(AGENT_REQUEST *request,
...
@@ -563,11 +523,7 @@ int	proc_num(AGENT_REQUEST *request, AGE
 	}
 	else
 	{
-#if (__FreeBSD_version) > 500000
...
@@ -604,33 +560,22 @@ int	proc_num(AGENT_REQUEST *request, AGE
 		{
...
@@ -661,8 +606,13 @@ static char	*get_state(struct kinfo_proc
...
@@ -670,17 +620,6 @@ static char	*get_state(struct kinfo_proc
 		case SSTOP:
...
@@ -836,7 +775,7 @@ int	proc_get(AGENT_REQUEST *request, AGE
 			sz = 0;
...
@@ -915,16 +854,8 @@ int	proc_get(AGENT_REQUEST *request, AGE
