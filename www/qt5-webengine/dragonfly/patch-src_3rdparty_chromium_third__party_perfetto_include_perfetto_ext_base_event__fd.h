--- src/3rdparty/chromium/third_party/perfetto/include/perfetto/ext/base/event_fd.h.intermediate	2020-04-21 17:37:26 UTC
...
+  (PERFETTO_BUILDFLAG(PERFETTO_OS_LINUX) || PERFETTO_BUILDFLAG(PERFETTO_OS_ANDROID))
