--- libraries/ghc-boot/GHC/BaseDir.hs.orig	2023-05-25 23:03:00 UTC
...
+#elif defined(darwin_HOST_OS) || defined(linux_HOST_OS) || defined(freebsd_HOST_OS) || defined(dragonfly_HOST_OS)
 import System.Environment (getExecutablePath)
 #endif
