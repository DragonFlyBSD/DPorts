...
# $FreeBSD: Tools/scripts/mark_safe.pl 340851 2014-01-23 19:55:14Z mat $
#
...
### version
our $VERSION = do { my @r = (q$FreeBSD: Tools/scripts/mark_safe.pl 340851 2014-01-23 19:55:14Z mat $ =~ /\d+/g); sprintf "%d." . "%02d" x $#r, @r };
