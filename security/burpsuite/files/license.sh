...
1.2.1    download, install and use the Software for your internal business
purposes (which includes bespoke client consultancy, if appropriate) only; and
...
functionality of the Software and disclose the findings of such analysis to any
party provided that such findings are provided simultaneously and in identical
form to the Licensor; or
...
terms specified in paragraph 1.3.1 above and, during the Licence Period, you
agree to be bound by this Licence Agreement directly in favour of the Licensor.
...
2.2.1    not to use the Software or the Documentation for any unlawful
purposes, particularly as Burp Suite Free Edition contains functionality that
...
2.2.4    not to rent, lease, sub-license, loan, translate, merge, adapt, vary
or modify the Software or Documentation;

2.2.5    not to make alterations to, or modifications of, the whole or any part
...
Downloading Burp Suite Free Edition does not entitle you to any product
support. Although reasonable efforts may be made to support you if you are
experiencing problems or bugs or require feature enhancements, any support will
be provided at the Licensor’s sole discretion.

4.    INTELLECTUAL PROPERTY RIGHTS

4.1    You acknowledge that all intellectual property rights in the Software
...
4.2    You acknowledge that you have no right to have access to the Software in
source code form
...
runtime environment for which it was designed as referred to herein).

5.2    You acknowledge that the Software has not been developed to meet your
...
5.3    You acknowledge that the Software may not be free of bugs or errors, and
agree that the existence of minor errors shall not constitute a breach of this
Licence.

5.4    If, within the Warranty Period, you notify the Licensor in writing of
...
6.1    Nothing in this Licence shall limit or exclude the liability of either
