--- vendor/github.com/shirou/gopsutil/internal/common/common_dragonfly.go.orig	2021-06-23 09:15:43 UTC
+++ vendor/github.com/shirou/gopsutil/internal/common/common_dragonfly.go
@@ -0,0 +1,85 @@
+// +build dragonfly
+
+package common
